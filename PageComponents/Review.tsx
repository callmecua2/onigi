...
const Review = () => {
  return (
    <>
      <div className="review-section w-full text-center ">
        <h1 className="mb-10 review-title">What Our Customers Said</h1>
        <div className="review-wrapper flex flex-wrap items-center justify-center gap-6 pt-14">
          <div className="card-review text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5">
